  ...
  return (
    ...
    >
      <Container className="relative z-10">
        <div>
          <h1 className="font-sans text-4xl font-extrabold uppercase leading-[0.95] tracking-[0.12em] sm:text-6xl md:text-7xl">
            <span className="text-crimson-400">London</span>
            <br />
            <span className="text-cream">Community</span>
          </h1>
          <p className="relative z-10 -mt-1 font-serif text-6xl italic text-gold-400 sm:-mt-3 sm:text-8xl md:text-9xl">
            Fest
          </p>
