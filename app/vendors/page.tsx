...
export const metadata: Metadata = {
  ...
  description:
    "Apply for a food, fashion, or business stall at London Community Fest 2026. Reach 4,000+ families at Kennington Park.",
};
        ...
        >
          <Container>
            ...
            <SectionHeading
              ...
              description="Halal food, modest fashion, and community organisations welcome. Reach 4,000+ families at Kennington Park."
              className="mt-6 mb-0"
            />
          </Container>
        </section>
