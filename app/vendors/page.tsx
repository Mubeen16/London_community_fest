...
export const metadata: Metadata = {
  ...
  description:
    "Apply for a food, fashion, or business stall at London Community Fest 2026. Reach 2,000+ visitors at Kennington Park.",
};
        ...
        >
          <Container>
            ...
            <SectionHeading
              ...
              description="Food, fashion, market, and community stalls welcome. Reach 2,000+ visitors at Kennington Park."
              className="mt-6 mb-0"
            />
          </Container>
        </section>
